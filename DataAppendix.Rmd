...
Our primary hypothesis is that of those family participating in the food stamps, they will all have the same level of food security adjusting for all other confounding variables. In other words, that there is no difference between regions and food security level. 
...
```
##Does this data pass our assumptions?
...
Model: $FoodSecurity = 0.849Northeast - 0.009NorthCentral/Midwest + 0.00437South + 0.073West$
